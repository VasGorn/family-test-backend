...
import com.vesmer.familytestbackend.dto.apierror.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
        ...
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage(
                String.format("The parameter '%s' of value '%s' could " +
                        "not be converted to type '%s'", ex.getName(),
    ...
    protected ResponseEntity<Object> handleAppError(FamilyException ex) {
